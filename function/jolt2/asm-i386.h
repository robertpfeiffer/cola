/* asm-i386.h -- dynamic assembler for i386
 *
...
#define _r8(R)		(_r8P(R) ? _rN(R) : ASMFAIL("64-bit register required"))
...
#define _r_0DIS(R, D,  I,S)		(_Mrm(_b00,_rN(R),_b100 ),_SIB(_SCL(S),_r4(I),    5 ),_L(D))
...
#define MOVBrr(RS, RD)			_O_Mrm		(0x88		,_b11,_r1(RS),_r1(RD)				)
...
#define MOVSBLrr(RS,RD)			_OO_Mrm		(0x0fbe		,_b11,_r1(RS),_r4(RD)				)
#define MOVSBLmr(MD,MB,MI,MS,RD)	_OO_r_X		(0x0fbe		     ,_r4(RD)		,MD,MB,MI,MS		)
#define MOVSWLrr(RS,RD)			_OO_Mrm		(0x0fbf		,_b11,_r2(RS),_r4(RD)				)
#define MOVSWLmr(MD,MB,MI,MS,RD)	_OO_r_X		(0x0fbf		     ,_r4(RD)		,MD,MB,MI,MS		)

#define MOVZBLrr(RS,RD)			_OO_Mrm		(0x0fb6		,_b11,_r1(RS),_r4(RD)				)
#define MOVZBLmr(MD,MB,MI,MS,RD)	_OO_r_X		(0x0fb6		     ,_r4(RD)		,MD,MB,MI,MS		)
#define MOVZWLrr(RS,RD)			_OO_Mrm		(0x0fb7		,_b11,_r2(RS),_r4(RD)				)
...
#define MOVDqr(RS,RD)			_OO_Mrm		(0x0f7e		,_b11,_r8(RS),_r4(RD)				)
#define MOVDrq(RS,RD)			_OO_Mrm		(0x0f6e		,_b11,_r8(RD),_r4(RS)				)
#define MOVQqq(RS,RD)			_OO_Mrm		(0x0f6f		,_b11,_r8(RD),_r8(RS)				)

#define PACKUSWBqq(RS,RD)		_OO_Mrm		(0x0f67		,_b11,_r8(RD),_r8(RS)				)
#define PADDUSBqq(RS,RD)		_OO_Mrm		(0x0fdc		,_b11,_r8(RD),_r8(RS)				)
#define PADDUSWqq(RS,RD)		_OO_Mrm		(0x0fdd		,_b11,_r8(RD),_r8(RS)				)
#define PMULLWqq(RS,RD)			_OO_Mrm		(0x0fd5		,_b11,_r8(RD),_r8(RS)				)
#define PSRAWiq(IM,RD)			_OO_Mrm_B	(0x0f71		,_b11,      4,_r8(RD)			,_u1(IM))
#define PSRLWiq(IM,RD)			_OO_Mrm_B	(0x0f71		,_b11,      2,_r8(RD)			,_u1(IM))
#define PSRLQiq(IM,RD)			_OO_Mrm_B	(0x0f72		,_b11,      2,_r8(RD)			,_u1(IM))
#define PSUBUSBqq(RS,RD)		_OO_Mrm		(0x0fd8		,_b11,_r8(RD),_r8(RS)				)
#define PSUBUSWqq(RS,RD)		_OO_Mrm		(0x0fd9		,_b11,_r8(RD),_r8(RS)				)
#define PUNPCKLBWqq(RS,RD)		_OO_Mrm		(0x0f60		,_b11,_r8(RD),_r8(RS)				)
#define PXORqq(RS,RD)			_OO_Mrm		(0x0fef		,_b11,_r8(RD),_r8(RS)				)
