/* generated by Id 1.0 at 2007-04-02 22:24:10 Z */
/* with the command: -I/usr/local/lib/idc/i686-pc-linux-gnu/ -I. -I../objects -m bench-id.st -o bench-id.c */
...
static oop Integer__nfibs(oop v__closure, oop v_stateful_self, oop v_self)
 {
  oop _1= 0;
  oop _2= 0;
  oop _3= 0;
...
void __id__init__(void)
{
  ...
  l_3= _send(s_value_5f_, v_SmallInteger, 35);
 {
  oop _1= 0;
  oop _2= 0;
  _1= v_StdOut;
