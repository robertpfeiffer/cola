/* Automatically generated from Squeak on #(3 September 2003 4:54:12 pm) */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"BitBltPlugin 3 September 2003 (i)"
#else
	"BitBltPlugin 3 September 2003 (e)"
#endif
;
static int nWords;
	...
	if (skew == -32) {
		...
		if (skew < 0) {
			...
			if (skew == 0) {
				...
				unskew = skew - 32;
				skewMask = ((unsigned) AllOnes) >> skew;
			}
		}
	}
