...
static oop TemporaryVariableNode__generate_location_(oop v__closure, oop v_stateful_self, oop v_self, oop v_gen, oop v_location)
 {
  _enter("generate:location:", "TemporaryVariableNode", "/home/piumarta/src/idst/object/idc/TemporaryVariableNode.st");
  oop _1= 0;
  oop _2= 0;
  oop _3= 0;
  _line(26);
...
static oop TemporaryVariableNode__generateStore_location_(oop v__closure, oop v_stateful_self, oop v_self, oop v_gen, oop v_location)
 {
  _enter("generateStore:location:", "TemporaryVariableNode", "/home/piumarta/src/idst/object/idc/TemporaryVariableNode.st");
  oop _1= 0;
  oop _2= 0;
  oop _3= 0;
  _line(31);
...
# define GC_add_roots _libid->gc_addRoots
  ...
  _enter("__id__init__", "<initialisation>", "TemporaryVariableNode.st");

  _send(s__5fimport_, _libid->_object, "LocalVariableNode", "__id__init__LocalVariableNode");
  ...
  v_TemporaryVariableNode= _libid->proto(v_LocalVariableNode);
