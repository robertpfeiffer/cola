...
void __id__init__ReadStream(void)
{
...
# define GC_add_roots _local_gc_addRoots
  ...
  _method(v_ReadStream, s__5fsizeof, ReadStream___5fsizeof);
  _method(v_ReadStream, s__5fdebugName, ReadStream___5fdebugName);
  _id_export("ReadStream", v_ReadStream);
  l_1= _send(s_value_5f_, v_SmallInteger, 1);
  _method(v_ReadStream, s_next, ReadStream__next);
  l_2= _send(s_value_5f_, v_SmallInteger, 1);
  _method(v_ReadStream, s_next_, ReadStream__next_);
  _method(v_ReadStream, s_readStream, ReadStream__readStream);
  _method(v_SequenceableCollection, s_readStream, SequenceableCollection__readStream);
  _leave();
}
