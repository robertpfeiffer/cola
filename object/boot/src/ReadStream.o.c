...
static oop ReadStream__next(oop v__closure, oop v_stateful_self, oop v_self)
 {
  _enter("next", "ReadStream", "/home/piumarta/src/idst/object/st80/ReadStream.st");
  oop _1= 0;
  oop _2= 0;
  oop _3= 0;
  _line(25);
...
static oop ReadStream__readStream(oop v__closure, oop v_stateful_self, oop v_self)
 {
  _enter("readStream", "ReadStream", "/home/piumarta/src/idst/object/st80/ReadStream.st");
  oop _1= 0;
  _line(45);
  _1= v_self;
  _leave();
...
static oop SequenceableCollection__readStream(oop v__closure, oop v_stateful_self, oop v_self)
 {
  _enter("readStream", "SequenceableCollection", "/home/piumarta/src/idst/object/st80/ReadStream.st");
  oop _1= 0;
  oop _2= 0;
  _line(49);
  _1= v_ReadStream;
...
# define GC_add_roots _libid->gc_addRoots
  ...
  _enter("__id__init__", "<initialisation>", "ReadStream.st");
  ...
  v_ReadStream= _libid->proto(v_PositionableStream);
