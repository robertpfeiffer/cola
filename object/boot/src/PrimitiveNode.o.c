/* generated by Id 1.0 at 2007-09-02 14:35:01 Z */
...
static oop PrimitiveNode__withCode_position_(oop v__closure, oop v_stateful_self, oop v_self, oop v_codeString, oop v_aPosition)
 {
  _enter("withCode:position:", "PrimitiveNode", "/home/piumarta/src/idst/object/idc/PrimitiveNode.st");
  oop _1= 0;
  oop _2= 0;
  _line(27);
  _1= v_self;
...
static oop PrimitiveNode__println_(oop v__closure, oop v_stateful_self, oop v_self, oop v_indent)
 {
  _enter("println:", "PrimitiveNode", "/home/piumarta/src/idst/object/idc/PrimitiveNode.st");
  oop _1= 0;
  oop _2= 0;
  _line(34);
  _1= v_self;
...
static oop PrimitiveNode__encode_(oop v__closure, oop v_stateful_self, oop v_self, oop v_encoder)
 {
  _enter("encode:", "PrimitiveNode", "/home/piumarta/src/idst/object/idc/PrimitiveNode.st");
  oop _1= 0;
  _line(43);
  _1= v_encoder;
  _line(45);
  _1=_send(s_methodType, _1);
  ((struct t_PrimitiveNode *)v_stateful_self)->v_mtype= _1;
  _1= v_encoder;
  _line(47);
  _1=_send(s_push, _1);
...
static oop PrimitiveNode__generate_(oop v__closure, oop v_stateful_self, oop v_self, oop v_gen)
 {
  _enter("generate:", "PrimitiveNode", "/home/piumarta/src/idst/object/idc/PrimitiveNode.st");
  oop _1= 0;
  oop _2= 0;
  oop _3= 0;
  _line(50);
  ...
  _line(52);
  _1=_send(s_genPrimitive_in_, _1, _2, _3);
  _1= v_gen;
...
void __id__init__PrimitiveNode(void)
{
...
# define GC_add_roots _local_gc_addRoots
  ...
  _enter("__id__init__", "<initialisation>", "PrimitiveNode.st");
  ...
  _method(v_PrimitiveNode, s__5fsizeof, PrimitiveNode___5fsizeof);
  _method(v_PrimitiveNode, s__5fdebugName, PrimitiveNode___5fdebugName);
  _id_export("PrimitiveNode", v_PrimitiveNode);
  _method(v_PrimitiveNode, s_withCode_position_, PrimitiveNode__withCode_position_);
  l_1= _send(s_size_5f_value_5f_, v_ImmutableString, 12, "Primitive { ");
  l_2= _send(s_size_5f_value_5f_, v_ImmutableString, 1, "}");
  _method(v_PrimitiveNode, s_println_, PrimitiveNode__println_);
  _method(v_PrimitiveNode, s_encode_, PrimitiveNode__encode_);
  _method(v_PrimitiveNode, s_generate_, PrimitiveNode__generate_);
  _leave();
}
