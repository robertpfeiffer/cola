/* generated by Id 1.0 at 2007-09-02 14:34:20 Z */
...
void __id__init__IdentitySet(void)
{
...
# define GC_add_roots _local_gc_addRoots
  ...
  _method(v_IdentitySet, s__5fsizeof, IdentitySet___5fsizeof);
  _method(v_IdentitySet, s__5fdebugName, IdentitySet___5fdebugName);
  _id_export("IdentitySet", v_IdentitySet);
  l_1= _send(s_value_5f_, v_SmallInteger, 1);
  l_4= _send(s_value_5f_, v_SmallInteger, 0);
  _method(v_IdentitySet, s_scanFor_, IdentitySet__scanFor_);
  _leave();
}
