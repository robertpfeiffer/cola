...
static oop b_2(oop v__closure, oop v__self, oop v_index)
 {
  _enter("[]", "?", "/home/piumarta/src/idst/object/st80/IdentitySet.st");
  oop v_element= 0;
  oop _1= 0;
  oop _2= 0;
  oop _3= 0;
...
static oop IdentitySet__scanFor_(oop v__closure, oop v_stateful_self, oop v_self, oop v_anObject)
 {
  _enter("scanFor:", "IdentitySet", "/home/piumarta/src/idst/object/st80/IdentitySet.st");
...
# define GC_add_roots _libid->gc_addRoots
  ...
  _enter("__id__init__", "<initialisation>", "IdentitySet.st");
  ...
  v_IdentitySet= _libid->proto(v_Set);
