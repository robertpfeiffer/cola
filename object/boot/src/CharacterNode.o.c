/* generated by Id 1.0 at 2007-09-02 14:34:49 Z */
...
static oop CharacterNode__encode_(oop v__closure, oop v_stateful_self, oop v_self, oop v_encoder)
 {
  _enter("encode:", "CharacterNode", "/home/piumarta/src/idst/object/idc/CharacterNode.st");
  oop _1= 0;
  oop _2= 0;
  oop _3= 0;
  _line(24);
...
static oop CharacterNode__genInitialisation_(oop v__closure, oop v_stateful_self, oop v_self, oop v_gen)
 {
  _enter("genInitialisation:", "CharacterNode", "/home/piumarta/src/idst/object/idc/CharacterNode.st");
  oop _1= 0;
  oop _2= 0;
  oop _3= 0;
  oop _4= 0;
  ...
  _line(33);
  _1=_send(s_initialiseCharacter_constructor_with_, _1, _2, _3, _4);
  _1= v_self;
  _leave();
  return _1;
  _leave();
...
static oop CharacterNode__generate_(oop v__closure, oop v_stateful_self, oop v_self, oop v_gen)
 {
  _enter("generate:", "CharacterNode", "/home/piumarta/src/idst/object/idc/CharacterNode.st");
  oop _1= 0;
  oop _2= 0;
  oop _3= 0;
  _line(36);
...
static oop CharacterNode__println_(oop v__closure, oop v_stateful_self, oop v_self, oop v_indent)
 {
  _enter("println:", "CharacterNode", "/home/piumarta/src/idst/object/idc/CharacterNode.st");
  oop _1= 0;
  oop _2= 0;
  _line(41);
  _1= v_self;
...
void __id__init__CharacterNode(void)
{
...
# define GC_add_roots _local_gc_addRoots
  ...
  _enter("__id__init__", "<initialisation>", "CharacterNode.st");
  ...
  _method(v_CharacterNode, s__5fsizeof, CharacterNode___5fsizeof);
  _method(v_CharacterNode, s__5fdebugName, CharacterNode___5fdebugName);
  _id_export("CharacterNode", v_CharacterNode);
  l_1= _send(s_size_5f_value_5f_, v_ImmutableString, 9, "character");
  _method(v_CharacterNode, s_encode_, CharacterNode__encode_);
  _method(v_CharacterNode, s_genInitialisation_, CharacterNode__genInitialisation_);
  _method(v_CharacterNode, s_generate_, CharacterNode__generate_);
  _method(v_CharacterNode, s_println_, CharacterNode__println_);
  _leave();
}
