/* generated by Id 1.0 at 2007-06-29 20:09:26 Z */
/* with the command: -I../stage1/ -I. -I../st80 -c VarargNode.st -o ../stage2/VarargNode.o.c */
...
static oop VarargNode__encode_(oop v__closure, oop v_stateful_self, oop v_self, oop v_encoder)
 {
  _enter("encode:", "VarargNode", "/Users/piumarta/src/idst/object/idc/VarargNode.st");
  oop _1= 0;
  _line(27);
  _1= v_encoder;
  _line(29);
...
static oop VarargNode__generate_(oop v__closure, oop v_stateful_self, oop v_self, oop v_gen)
 {
  _enter("generate:", "VarargNode", "/Users/piumarta/src/idst/object/idc/VarargNode.st");
  oop _1= 0;
  oop _2= 0;
  oop _3= 0;
  _line(32);
...
static oop VarargNode__println_(oop v__closure, oop v_stateful_self, oop v_self, oop v_indent)
 {
  _enter("println:", "VarargNode", "/Users/piumarta/src/idst/object/idc/VarargNode.st");
  oop _1= 0;
  oop _2= 0;
  _line(37);
  _1= v_self;
...
void __id__init__VarargNode(void)
{
...
# define GC_add_roots _local_gc_addRoots
  ...
  v_VarargNode= _proto(v_ParseNode);
  _method(v_VarargNode, s__5fsizeof, VarargNode___5fsizeof);
  _method(v_VarargNode, s__5fdebugName, VarargNode___5fdebugName);
  _id_export("VarargNode", v_VarargNode);
  _method(v_VarargNode, s_encode_, VarargNode__encode_);
  _method(v_VarargNode, s_generate_, VarargNode__generate_);
  l_1= _send(s_size_5f_value_5f_, v_ImmutableString, 3, "...");
  _method(v_VarargNode, s_println_, VarargNode__println_);
  _leave();
}
