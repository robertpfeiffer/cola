/* generated by Id 1.0 at 2007-09-02 14:34:12 Z */
...
void __id__init__ArrayedCollection(void)
{
...
# define GC_add_roots _local_gc_addRoots
  ...
  _method(v_ArrayedCollection, s_new_withAll_, ArrayedCollection__new_withAll_);
  l_1= _send(s_value_5f_, v_SmallInteger, 0);
  _method(v_ArrayedCollection, s_initialize, ArrayedCollection__initialize);
  _method(v_ArrayedCollection, s_initialize_, ArrayedCollection__initialize_);
  l_2= _send(s_value_5f_, v_SmallInteger, 1);
  _method(v_ArrayedCollection, s_with_, ArrayedCollection__with_);
  l_3= _send(s_value_5f_, v_SmallInteger, 2);
  l_4= _send(s_value_5f_, v_SmallInteger, 1);
  _method(v_ArrayedCollection, s_with_with_, ArrayedCollection__with_with_);
  _method(v_ArrayedCollection, s_withAll_, ArrayedCollection__withAll_);
  _method(v_ArrayedCollection, s_size, ArrayedCollection__size);
  _method(v_ArrayedCollection, s_byteSize, ArrayedCollection__byteSize);
  _method(v_ArrayedCollection, s_collect_, ArrayedCollection__collect_);
  _method(v_ArrayedCollection, s__5fsize, ArrayedCollection___5fsize);
  _leave();
}
