/* generated by Id 1.1 at 2007-09-03 20:58:46 Z */
...
static oop b_2(oop v__closure, oop v__self, oop v_opt)
 {
  _enter("[]", "?", "/home/piumarta/src/idst/object/idc/idc1.st");
  oop _1= 0;
  oop _2= 0;
  _line(31);
...
static oop b_24(oop v__closure, oop v__self, oop v_opt, oop v_arg)
 {
  _enter("[]", "?", "/home/piumarta/src/idst/object/idc/idc1.st");
  oop _1= 0;
  oop _2= 0;
...
static oop b_26(oop v__closure, oop v__self, oop v_opt)
 {
  _enter("[]", "?", "/home/piumarta/src/idst/object/idc/idc1.st");
  oop _1= 0;
  oop _2= 0;
...
static oop b_27(oop v__closure, oop v__self, oop v_arg)
 {
  _enter("[]", "?", "/home/piumarta/src/idst/object/idc/idc1.st");
  oop _1= 0;
  oop _2= 0;
...
void __id__init__(struct __libid *__libid)
{
  ...
  _enter("__id__init__", "<initialisation>", "idc1.st");

  _send(s__5fimport_, _libid->_object, "st80", "__id__init__st80");
  ...
  _send(s__5fimport_, _libid->_object, "idst", "__id__init__idst");
  ...
  l_3= _send(s_value_5f_, v_Character, 103);
  l_5= _send(s_value_5f_, v_Character, 73);
  l_7= _send(s_value_5f_, v_Character, 109);
  l_9= _send(s_value_5f_, v_Character, 77);
  l_11= _send(s_value_5f_, v_Character, 78);
  l_13= _send(s_value_5f_, v_Character, 111);
  l_15= _send(s_value_5f_, v_Character, 115);
  l_17= _send(s_value_5f_, v_Character, 83);
  l_19= _send(s_value_5f_, v_Character, 84);
  l_21= _send(s_value_5f_, v_Character, 118);
  l_23= _send(s_value_5f_, v_Character, 120);
  l_25= _send(s_value_5f_, v_Character, 63);
  l_28= _send(s_value_5f_, v_SmallInteger, 0);
  l_29= _send(s_value_5f_, v_SmallInteger, 1);
  l_30= _send(s_size_5f_value_5f_, v_ImmutableString, 24, "no source file specified");
  l_31= _send(s_size_5f_value_5f_, v_ImmutableString, 31, "multiple source files specified");
  l_32= _send(s_size_5f_value_5f_, v_ImmutableString, 1, ".");
  l_33= _send(s_size_5f_value_5f_, v_Symbol, 6, "object");
  l_34= _send(s_size_5f_value_5f_, v_Symbol, 7, "program");
  l_35= _send(s_size_5f_value_5f_, v_Symbol, 6, "shared");
  l_36= _send(s_size_5f_value_5f_, v_ImmutableString, 17, "illegal option: -");
  l_26= _send(s_function_5f_arity_5f_, v_StaticBlockClosure, b_26, 1);
 {
  ...
  /* 2 */
  /* 1 */
  _3= _send(s_function_5f_arity_5f_outer_state_nlr_5f_, v_BlockClosure, (oop)b_4, 1, 0, ((oop *)_state1), 0);
  _send(s_at_put_, _1, _2, _3);
  _2= l_5;
  ...
  /* 2 */
  /* 1 */
  _3= _send(s_function_5f_arity_5f_outer_state_nlr_5f_, v_BlockClosure, (oop)b_6, 2, 0, ((oop *)_state1), 0);
  _send(s_at_put_, _1, _2, _3);
  _2= l_7;
  /* Scope('opt'->ArgumentVariableNode) */
  /* Scope('outputPath'->TemporaryVariableNode 'files'->TemporaryVariableNode 'options'->TemporaryVariableNode) */
  ...
  /* 2 */
  /* 1 */
  _3= _send(s_function_5f_arity_5f_outer_state_nlr_5f_, v_BlockClosure, (oop)b_10, 1, 0, ((oop *)_state1), 0);
  _send(s_at_put_, _1, _2, _3);
  _2= l_11;
  /* Scope('opt'->ArgumentVariableNode 'arg'->ArgumentVariableNode) */
  /* Scope('outputPath'->TemporaryVariableNode 'files'->TemporaryVariableNode 'options'->TemporaryVariableNode) */
  ...
  /* 2 */
  /* 1 */
  _3= _send(s_function_5f_arity_5f_outer_state_nlr_5f_, v_BlockClosure, (oop)b_14, 2, 0, ((oop *)_state1), 0);
  _send(s_at_put_, _1, _2, _3);
  _2= l_15;
  /* Scope('opt'->ArgumentVariableNode) */
  /* Scope('outputPath'->TemporaryVariableNode 'files'->TemporaryVariableNode 'options'->TemporaryVariableNode) */
  ...
  /* 2 */
  /* 1 */
  _3= _send(s_function_5f_arity_5f_outer_state_nlr_5f_, v_BlockClosure, (oop)b_24, 2, 0, ((oop *)_state1), 0);
  _send(s_at_put_, _1, _2, _3);
  _2= l_25;
  _3= l_26;
  _send(s_at_put_, _1, _2, _3);
  ...
  /* 2 */
  /* 1 */
  _2= _send(s_function_5f_arity_5f_outer_state_nlr_5f_, v_BlockClosure, (oop)b_27, 1, 0, ((oop *)_state1), 0);
