...
void __id__init__WeakArray(void)
{
...
# define GC_add_roots _local_gc_addRoots
  ...
  v_WeakArray= _proto(v_Array);
  _method(v_WeakArray, s__5fsizeof, WeakArray___5fsizeof);
  _method(v_WeakArray, s__5fdebugName, WeakArray___5fdebugName);
  _id_export("WeakArray", v_WeakArray);
  _method(v_Object, s__5fnewWeakPointers_, Object___5fnewWeakPointers_);
  _method(v_WeakArray, s__5fnewPointers_, WeakArray___5fnewPointers_);
  _method(v_WeakArray, s_at_put_, WeakArray__at_put_);
  _leave();
}
