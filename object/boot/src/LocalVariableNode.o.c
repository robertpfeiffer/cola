...
void __id__init__LocalVariableNode(void)
{
...
# define GC_add_roots _local_gc_addRoots
  ...
  v_LocalVariableNode= _proto(v_EncodedVariableNode);
  _method(v_LocalVariableNode, s__5fsizeof, LocalVariableNode___5fsizeof);
  _method(v_LocalVariableNode, s__5fdebugName, LocalVariableNode___5fdebugName);
  _id_export("LocalVariableNode", v_LocalVariableNode);
  _method(v_LocalVariableNode, s_withName_position_scope_, LocalVariableNode__withName_position_scope_);
  _method(v_LocalVariableNode, s_index_, LocalVariableNode__index_);
  _method(v_LocalVariableNode, s_index, LocalVariableNode__index);
  _leave();
}
