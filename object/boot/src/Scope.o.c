...
static oop Scope__stateVectorSize(oop v__closure, oop v_stateful_self, oop v_self)
 {
  ...
  /* Scope('exportFlag'->SlotVariableNode 'importFlag'->SlotVariableNode 'nlrFlag'->SlotVariableNode 'argumentCount'->SlotVariableNode 'temporaryCount'->SlotVariableNode 'stateful_self'->ArgumentVariableNode 'stackSize'->SlotVariableNode 'self'->ArgumentVariableNode 'tag'->SlotVariableNode 'blocks'->SlotVariableNode 'outer'->SlotVariableNode 'encodings'->SlotVariableNode 'tally'->SlotVariableNode 'array'->SlotVariableNode 'size'->TemporaryVariableNode 'lastOffset'->SlotVariableNode 'level'->SlotVariableNode) */
  /* nil */
  /* 2 */
  /* 1 */
