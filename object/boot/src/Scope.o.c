...
# define GC_add_roots _libid->gc_addRoots
  ...
  _send(s__5fimport_, _libid->_object, "SlotVariableNode", "__id__init__SlotVariableNode");
  v_SlotVariableNode= _libid->import("SlotVariableNode");
  _send(s__5fimport_, _libid->_object, "ArgumentVariableNode", "__id__init__ArgumentVariableNode");
  ...
  _send(s__5fimport_, _libid->_object, "TemporaryVariableNode", "__id__init__TemporaryVariableNode");
  v_TemporaryVariableNode= _libid->import("TemporaryVariableNode");
  v_Scope= _libid->proto(v_Dictionary);
