/* generated by Id 1.0 at 2007-05-22 17:36:19 Z */
/* with the command: -I../stage1/ -I. -I../st80 -c CompilerOptions.st -o ../stage2/CompilerOptions.o.c */
...
#ifdef ID_DEBUG
# define _enter(NM, TYPE, FILE)	_local_nlresult(NM, TYPE, FILE)
# define _line(LINE)		_local_nlresult(LINE)
# define _leave()		_local_nlresult()
# define _backtrace()		_local_nlresult()
#else
...
# define GC_add_roots _local_gc_addRoots
  ...
  l_5= _send(s_size_5f_value_5f_, v_ImmutableString, 1, "0");
  l_6= _send(s_value_5f_, v_SmallInteger, 0);
  l_7= _send(s_size_5f_value_5f_, v_ImmutableString, 1, "1");
  l_8= _send(s_value_5f_, v_SmallInteger, 1);
  l_9= _send(s_size_5f_value_5f_, v_ImmutableString, 21, "illegal cache level: ");
  ...
  l_10= _send(s_size_5f_value_5f_, v_ImmutableString, 6, "native");
  l_11= _send(s_size_5f_value_5f_, v_Symbol, 6, "native");
  l_12= _send(s_size_5f_value_5f_, v_ImmutableString, 7, "managed");
  l_13= _send(s_size_5f_value_5f_, v_Symbol, 7, "managed");
  l_14= _send(s_size_5f_value_5f_, v_ImmutableString, 25, "illegal execution model: ");
