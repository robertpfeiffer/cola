...
void __id__init__GlobalVariableNode(void)
{
...
# define GC_add_roots _local_gc_addRoots
  ...
  v_GlobalVariableNode= _proto(v_EncodedVariableNode);
  _method(v_GlobalVariableNode, s__5fsizeof, GlobalVariableNode___5fsizeof);
  _method(v_GlobalVariableNode, s__5fdebugName, GlobalVariableNode___5fdebugName);
  _id_export("GlobalVariableNode", v_GlobalVariableNode);
  _method(v_GlobalVariableNode, s_isGlobal, GlobalVariableNode__isGlobal);
  _method(v_EncodedVariableNode, s_isGlobal, EncodedVariableNode__isGlobal);
  _method(v_GlobalVariableNode, s_generate_location_, GlobalVariableNode__generate_location_);
  _method(v_GlobalVariableNode, s_generateStore_location_, GlobalVariableNode__generateStore_location_);
  _leave();
}
