...
void __id__init__ArrayLiteralNode(void)
{
...
# define GC_add_roots _local_gc_addRoots
  ...
  v_ArrayLiteralNode= _proto(v_LiteralNode);
  _method(v_ArrayLiteralNode, s__5fsizeof, ArrayLiteralNode___5fsizeof);
  _method(v_ArrayLiteralNode, s__5fdebugName, ArrayLiteralNode___5fdebugName);
  _id_export("ArrayLiteralNode", v_ArrayLiteralNode);
  _method(v_ArrayLiteralNode, s_withElements_position_, ArrayLiteralNode__withElements_position_);
  _method(v_ArrayLiteralNode, s_generate_, ArrayLiteralNode__generate_);
  _leave();
}
