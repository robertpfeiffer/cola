/* generated by Id 1.0 at 2007-04-24 00:12:00 Z */
/* with the command: -I../stage1/ -I. -I../st80 -c WordArrayNode.st -o ../stage2/WordArrayNode.o.c */
...
void __id__init__WordArrayNode(void)
{
...
# define GC_add_roots _local_gc_addRoots
  ...
  v_WordArrayNode= _proto(v_ArrayLiteralNode);
  _method(v_WordArrayNode, s__5fsizeof, WordArrayNode___5fsizeof);
  _method(v_WordArrayNode, s__5fdebugName, WordArrayNode___5fdebugName);
  _id_export("WordArrayNode", v_WordArrayNode);
  l_1= _send(s_size_5f_value_5f_, v_ImmutableString, 9, "wordArray");
  l_2= _send(s_function_5f_arity_5f_, v_StaticBlockClosure, b_2, 1);
  _method(v_WordArrayNode, s_encode_, WordArrayNode__encode_);
  _method(v_WordArrayNode, s_genDefinition_, WordArrayNode__genDefinition_);
  _method(v_WordArrayNode, s_genInitialisation_, WordArrayNode__genInitialisation_);
  ...
  _method(v_WordArrayNode, s_println_, WordArrayNode__println_);
}
