...
void __id__init__LiteralNode(void)
{
...
# define GC_add_roots _local_gc_addRoots
  ...
  v_LiteralNode= _proto(v_ParseNode);
  _method(v_LiteralNode, s__5fsizeof, LiteralNode___5fsizeof);
  _method(v_LiteralNode, s__5fdebugName, LiteralNode___5fdebugName);
  _id_export("LiteralNode", v_LiteralNode);
  _method(v_LiteralNode, s_isLiteralNode, LiteralNode__isLiteralNode);
  _method(v_Object, s_isLiteralNode, Object__isLiteralNode);
  _method(v_LiteralNode, s_withValue_position_, LiteralNode__withValue_position_);
  _method(v_LiteralNode, s_value, LiteralNode__value);
  _method(v_LiteralNode, s_tag, LiteralNode__tag);
  _method(v_LiteralNode, s_hash, LiteralNode__hash);
  _method(v_LiteralNode, s__3d, LiteralNode___3d);
  _method(v_LiteralNode, s_genDeclaration_, LiteralNode__genDeclaration_);
  _method(v_LiteralNode, s_genDefinition_, LiteralNode__genDefinition_);
  _leave();
}
