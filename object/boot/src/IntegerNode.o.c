/* generated by Id 1.0 at 2007-02-22 05:40:07 Z */
...
# define GC_add_roots _local_gc_addRoots
  ...
  l_6= _send(s_size_5f_value_5f_, v_ImmutableString, 8, "Integer(");
  l_7= _send(s_size_5f_value_5f_, v_ImmutableString, 1, ")");
