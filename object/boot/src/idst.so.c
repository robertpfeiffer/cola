/* generated by Id 1.1 at 2007-09-03 20:38:22 Z */
...
# define GC_add_roots _libid->gc_addRoots
  ...
  _send(s__5fimport_, _libid->_object, "Compiler", "__id__init__Compiler");
  v_Stream= _libid->import("Stream");
  v_PositionableStream= _libid->import("PositionableStream");
  v_Scanner= _libid->import("Scanner");
  _send(s__5fimport_, _libid->_object, "CompilerOptions", "__id__init__CompilerOptions");
  _leave();
}
