/* generated by Id 1.0 at 2007-09-02 14:34:56 Z */
...
void __id__init__IncludeNode(void)
{
...
# define GC_add_roots _local_gc_addRoots
  ...
  _method(v_IncludeNode, s__5fsizeof, IncludeNode___5fsizeof);
  _method(v_IncludeNode, s__5fdebugName, IncludeNode___5fdebugName);
  _id_export("IncludeNode", v_IncludeNode);
  _method(v_IncludeNode, s_withName_position_, IncludeNode__withName_position_);
  _method(v_IncludeNode, s_addTo_, IncludeNode__addTo_);
  _method(v_IncludeNode, s_encode_, IncludeNode__encode_);
  _method(v_IncludeNode, s_genDeclaration_, IncludeNode__genDeclaration_);
  _method(v_IncludeNode, s_genDefinition_, IncludeNode__genDefinition_);
  _method(v_IncludeNode, s_genImplementation_, IncludeNode__genImplementation_);
  _method(v_IncludeNode, s_genInitialisation_, IncludeNode__genInitialisation_);
  l_1= _send(s_size_5f_value_5f_, v_ImmutableString, 9, "Include <");
  l_2= _send(s_size_5f_value_5f_, v_ImmutableString, 1, ">");
  _method(v_IncludeNode, s_println_, IncludeNode__println_);
  _leave();
}
